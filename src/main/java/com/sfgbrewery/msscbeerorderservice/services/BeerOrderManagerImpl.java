...
import com.sfgbrewery.msscbeerorderservice.sm.BeerOrderStateChangeInterceptor;
...
public class BeerOrderManagerImpl implements BeerOrderManager {
	...
	private void sendBeerOrderEvent(BeerOrder beerOrder, BeerOrderEventEnum eventEnum) {
		...
		Message msg = MessageBuilder.withPayload(eventEnum).setHeader(ORDER_ID_HEADER, beerOrder.getId().toString())
				.build();
